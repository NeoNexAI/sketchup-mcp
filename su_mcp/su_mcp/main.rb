...
module SU_MCP
  class Server
    ...
    # NOTA DE SEGURIDAD (NeoNexAI): la ejecucion de Ruby arbitrario (eval_ruby)
    # se ha ELIMINADO a proposito en este fork. Permitia que un agente ejecutara
    # cualquier codigo Ruby dentro de SketchUp (acceso total a disco/red del PC)
    # y fue el motivo por el que la auditoria de seguridad bloqueo el original.
    # Este fork expone solo operaciones curadas y acotadas de modelado.
  end
